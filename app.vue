<template>
  <div class=" bg-[#6a727f] w-auto h-[30px]"> 
    </div>

  <div class="flex  justify-center">
    <div class="bg-[#85eeab] w-[60%] h-screen grid grid-cols-2 p-8  ">
        <div class="flex justify-center items-center h-[200px]  ">
          <div class=" border-[1px] border-black  rounded-full  w-[100px] h-[100px] " ></div>
      </div>
